...
<body>
  <div class="topnav" id="myTopnav">
    ...
    <a href="leapYear.php" class="active w3-pink">Leap Year</a>
  ...
  <div class="w3-container w3-pink" id="header">
    <h1>The Leap Year</h1>
    <p>From 2010- 2022</p>
  ...
  <div class="w3-padding-large w3-container">
    ...
    <div class="w3-third">
      <div class="w3-padding-large w3-border w3-hover-border-pink">

        <?php
        // Create a for loop to check the limit from 2010- 2022.
        for ($year = 2010; $year <= 2022; $year++) {
          // Set the condition and print out the result.
          if ($year % 400 == 0) {
            echo "<br><b>The year " . $year . " is a leap year.</b><br>";
          } else if ($year % 100 == 0) {
            echo "<br>The year " . $year . " is not a leap year.<br>";
          } else if ($year % 4 == 0) {
            echo "<br><b>The year " . $year . " is a leap year.</b><br>";
          } else {
            echo "<br>The year " . $year . " is not a leap year.<br>";
