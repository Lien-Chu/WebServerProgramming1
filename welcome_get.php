...
<div class="w3-padding-large w3-container">
  ...
  <div class="w3-third">
      ...
      <div class="w3-padding-large w3-border w3-hover-border-blue">
        ...
        <p>When the user fills out the form to the left and clicks the submit button, 
            the form data is sent for processing to a paragraph Welcome. 
            The form data is sent with the HTTP GET method.</p>
